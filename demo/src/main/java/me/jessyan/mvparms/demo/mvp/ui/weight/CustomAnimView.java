package me.jessyan.mvparms.demo.mvp.ui.weight;
...
public class CustomAnimView extends LinearLayout {
    ...
    public void init(Context context, AttributeSet attrs) {
        View header = LayoutInflater.from(context).inflate(com.zhouyou.recyclerviewsdk.R.layout.clife_loading_header2, this);
        mImageView =(ImageView) header.findViewById(com.zhouyou.recyclerviewsdk.R.id.pull_to_refresh_image);
        mImageView.setImageResource(com.zhouyou.recyclerviewsdk.R.drawable.clife_refresh_loading);
