...
public class GlideImageLoaderStrategy implements BaseImageLoaderStrategy<ImageConfigImpl>, GlideAppliesOptions {
    ...
    public void loadImage(@Nullable Context ctx, @Nullable ImageConfigImpl config) {
        ...
        if (url.endsWith(".gif")) {
            GlideRequest<GifDrawable> glideGifRequest = requests.asGif().load(url);
            setGifDrawable(config, glideGifRequest);
        } else {
            GlideRequest<Drawable> glideRequest = requests.load(config.getUrl());
            setDrawable(config, glideRequest);
        }
    ...
    private void setGifDrawable(@Nullable ImageConfigImpl config, GlideRequest<GifDrawable> glideRequest) {
    ...
    private void setDrawable(@Nullable ImageConfigImpl config, GlideRequest<Drawable> glideRequest) {
